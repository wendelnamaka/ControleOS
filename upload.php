...
<head>
    ...
    <title>Bem Estar na Estrada</title>
...
<li>
    <div class="heading">
        <h1>Manutenção</h1>
        <span>Verifique informações de manutenção e colabore com os seus amigos de estrada.</span> 
    </div>
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8">
                        <center><h4>Adicione seus Orçamentos</h4></></center>
                    </div>
                    <div class="col-sm-4">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>90R$</td>
                        <td>
                            <a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-target="#addhor" title="Edit">&#xE254;</i></a>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="cod" id="cod_exc" />
